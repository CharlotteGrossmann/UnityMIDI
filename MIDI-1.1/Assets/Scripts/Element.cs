...
public class Element : MonoBehaviour
{
    ...
    void Awake ()
    {
        note = GameObject.Find("DebbugingGenerator").GetComponent<DebuggingGenerator>().note;
        velocity = GameObject.Find("DebbugingGenerator").GetComponent<DebuggingGenerator>().velocity;
        currentScale = 0.1f;
