    ...
    def __init__(self, back_plane_ip_address=BANYAN_IP,
        ...
        while True:
            ...
            try:
                ...
                unity_message = {"action":"StringRhythm", "info":"blue", "value": random.randint(40,127), "target":"Cube"} #chose random volume
                ...
                # Define the Unity message to be sent
                unity_message = {"action":"StringRhythm", "info":"blue", "value": 0, "target":"Cube"} # set component as inactive after playing a note
